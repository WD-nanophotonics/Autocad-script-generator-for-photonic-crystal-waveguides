...
if wg_type == '1_3':
    ...
    file.write('' + '\n')
    file.write('D' + '\n')
    file.write(str(-math.sqrt(3)*a/2) + ',' + str(y_phc_s+0.5*a) + '\n')
if wg_type == '2_3':
    file.write('move' + '\n')
    file.write('fence' + '\n')
    file.write(str(x - 5 * math.sqrt(3) * a) + ',' + str(y+0.5*a) + '\n')
...
file.write('crossing' + '\n')
file.write(str(x - 5 * math.sqrt(3) * a) + ',' + str(y) + '\n')
file.write(str(x + x_phc + 5 * math.sqrt(3) * a) + ',' + str(y+y_phc_s+a) + '\n')
file.write('' + '\n')
file.write('0,0' + '\n')
if wg_type == '1_6':
    file.write(str(a/math.sqrt(3)) + ',' + str(-y_plus) + '\n')
if wg_type == '5_6':
    file.write(str(-a/math.sqrt(3)) + ',' + str(-y_plus) + '\n')
if wg_type == '1_3':
    file.write(str(0.5*a/math.sqrt(3)) + ',' + str(-y_plus-0.5*a) + '\n')
if wg_type == '2_3':
    file.write(str(-0.5*a/math.sqrt(3)) + ',' + str(-y_plus-0.5*a) + '\n')
...
if wg_type == "1_6":
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_si_f+ math.sqrt(3) * a / 6) + ',' + str(y + 0 * a) + '\n')
    file.write(str(x_si_f - math.sqrt(3) * a / 4) + ',' + str(y + 0 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_si_f+ math.sqrt(3) * a / 6) + ',' + str(y + 1 * a) + '\n')
    file.write(str(x_si_f - math.sqrt(3) * a / 4) + ',' + str(y + 1 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    ...
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_si_f+ math.sqrt(3) * a / 6) + ',' + str(y + y_phc_s - 0 * a) + '\n')
    file.write(str(x_si_f - math.sqrt(3) * a / 4) + ',' + str(y + y_phc_s - 0 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_si_f+ math.sqrt(3) * a / 6) + ',' + str(y + y_phc_s - 1 * a) + '\n')
    file.write(str(x_si_f - math.sqrt(3) * a / 4) + ',' + str(y + y_phc_s - 1 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
...
if wg_type == "1_3":
    ...
    file.write('fence' + '\n')
    file.write(str(x_si_f - 5*math.sqrt(3) * a / 12) + ',' + str(y + y_phc_s) + '\n')
    file.write(str(x_si_f + 1*math.sqrt(3) * a / 12) + ',' + str(y + y_phc_s) + '\n')
    file.write(str(x_si_f + 1*math.sqrt(3) * a / 12) + ',' + str(y + y_phc_s-4.5*a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    ...
    file.write('fence' + '\n')
    file.write(str(x_si_f - 5*math.sqrt(3) * a / 12) + ',' + str(y) + '\n')
    file.write(str(x_si_f + 1*math.sqrt(3) * a / 12) + ',' + str(y) + '\n')
    file.write(str(x_si_f + 1*math.sqrt(3) * a / 12) + ',' + str(y+4.5*a) + '\n')
    file.write('' + '\n')
    file.write('\n')
...
if wg_type == "2_3":
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_si_f - math.sqrt(3) * a / 6) + ',' + str(y+0.5*a) + '\n')
    file.write(str(x_si_f + math.sqrt(3) * a / 6) + ',' + str(y+0.5*a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_si_f - math.sqrt(3) * a / 6) + ',' + str(y + y_phc_s-0.5*a) + '\n')
    file.write(str(x_si_f + math.sqrt(3) * a / 6) + ',' + str(y + y_phc_s-0.5*a) + '\n')
    file.write('' + '\n')
    file.write('\n')
if wg_type == "5_6":
    ...
    file.write('fence' + '\n')
    file.write(str(x_si_f) + ',' + str(y + 0 * a) + '\n')
    file.write(str(x_si_f) + ',' + str(y + 3 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_si_f) + ',' + str(y + y_phc_s - 0 * a) + '\n')
    file.write(str(x_si_f) + ',' + str(y + y_phc_s - 3 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
...
if wg_type == "1_6":
    ...
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_dsi_f) + ',' + str(y + 1 * a) + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 4) + ',' + str(y + 1 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    ...
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi_f) + ',' + str(y + y_phc_z - 1 * a) + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 4) + ',' + str(y + y_phc_z - 1 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
...
if wg_type == '1_3':
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 12) + ',' + str(y + 4 * a) + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 12) + ',' + str(y + 3 * a) + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 12) + ',' + str(y + 2 * a) + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 12) + ',' + str(y + 1 * a) + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 12) + ',' + str(y + 0 * a) + '\n')
    ...
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 12) + ',' + str(y + y_phc_z - 4 * a) + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 12) + ',' + str(y + y_phc_z - 3 * a) + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 12) + ',' + str(y + y_phc_z - 2 * a) + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 12) + ',' + str(y + y_phc_z - 1 * a) + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 12) + ',' + str(y + y_phc_z - 0 * a) + '\n')
...
file.write('crossing' + '\n')
file.write(str(x - 5 * math.sqrt(3) * a) + ',' + str(y) + '\n')
file.write(str(x + x_phc_z + 5 * math.sqrt(3) * a) + ',' + str(y+y_phc_z+a) + '\n')
file.write('' + '\n')
file.write('0,0' + '\n')
if wg_type == '1_6':
    file.write(str(a/math.sqrt(3)) + ',' + str(-y_plus) + '\n')
...
if wg_type == "1_6":
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_dsi_f+ math.sqrt(3) * a / 6) + ',' + str(y + 0 * a) + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 4) + ',' + str(y + 0 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_dsi_f+ math.sqrt(3) * a / 6) + ',' + str(y + 1 * a) + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 4) + ',' + str(y + 1 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    ...
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi_f+ math.sqrt(3) * a / 6) + ',' + str(y + y_phc_z - 0 * a) + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 4) + ',' + str(y + y_phc_z - 0 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi_f+ math.sqrt(3) * a / 6) + ',' + str(y + y_phc_z - 1 * a) + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 4) + ',' + str(y + y_phc_z - 1 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
...
if wg_type == "1_3":
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi_f - 5*math.sqrt(3) * a / 12) + ',' + str(y + y_phc_z) + '\n')
    file.write(str(x_usi_f + 1*math.sqrt(3) * a / 12) + ',' + str(y + y_phc_z) + '\n')
    file.write(str(x_usi_f + 1*math.sqrt(3) * a / 12) + ',' + str(y + y_phc_z-4.5*a) + '\n')
    file.write('' + '\n')
    file.write('\n')

    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_dsi_f - 5*math.sqrt(3) * a / 12) + ',' + str(y) + '\n')
    file.write(str(x_dsi_f + 1*math.sqrt(3) * a / 12) + ',' + str(y) + '\n')
    file.write(str(x_dsi_f + 1*math.sqrt(3) * a / 12) + ',' + str(y+4.5*a) + '\n')
    file.write('' + '\n')
    file.write('\n')
...
if wg_type == "2_3":
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_dsi_f - math.sqrt(3) * a / 6) + ',' + str(y+0.5*a) + '\n')
    file.write(str(x_dsi_f + math.sqrt(3) * a / 6) + ',' + str(y+0.5*a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi_f - math.sqrt(3) * a / 6) + ',' + str(y + y_phc_z-0.5*a) + '\n')
    file.write(str(x_usi_f + math.sqrt(3) * a / 6) + ',' + str(y + y_phc_z-0.5*a) + '\n')
    file.write('' + '\n')
    file.write('\n')
if wg_type == "5_6":
    ...
    file.write('fence' + '\n')
    file.write(str(x_dsi_f) + ',' + str(y + 0 * a) + '\n')
    file.write(str(x_dsi_f) + ',' + str(y + 3 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi_f) + ',' + str(y + y_phc_z - 0 * a) + '\n')
    file.write(str(x_usi_f) + ',' + str(y + y_phc_z - 3 * a) + '\n')
    file.write('' + '\n')
    file.write('\n')
...
file.write('move' + '\n')
file.write('crossing' + '\n')
file.write(str(x - 5 * math.sqrt(3) * a) + ',' + str(y-20*a) + '\n')
file.write(str(x + x_phc_z + 5 * math.sqrt(3) * a) + ',' + str(y+y_phc_z+21*a) + '\n')
file.write('' + '\n')
file.write('0,0' + '\n')
if wg_type == '1_6':
    file.write(str(2*a/math.sqrt(3)) + ',' + str(-y_plus) + '\n')
if wg_type == '5_6':
    file.write(str(-2*a/math.sqrt(3)) + ',' + str(-y_plus) + '\n')
if wg_type == '1_3':
    file.write(str(1*a/math.sqrt(3)) + ',' + str(-y_plus) + '\n')
if wg_type == '2_3':
    file.write(str(-1*a/math.sqrt(3)) + ',' + str(-y_plus) + '\n')
...
if wg_type == '1_6':
    ...
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_dsi - a * 3 * math.sqrt(3) / 4 + a * math.sqrt(3) / 8) + ',' + str(y_dsi + 3 * a / 4 + 3 * a / 8) + '\n')
    file.write(str(x_dsi - a * 3 * math.sqrt(3) / 4 - a * math.sqrt(3) / 8) + ',' + str(y_dsi + 3 * a / 4 - 3 * a / 8) + '\n')
    file.write('' + '\n')
    file.write('\n')
    ...
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi - a * 3 * math.sqrt(3) / 4 + a * math.sqrt(3) / 8) + ',' + str(y_usi - 3 * a / 4 - 3 * a / 8) + '\n')
    file.write(str(x_usi - a * 3 * math.sqrt(3) / 4 - a * math.sqrt(3) / 8) + ',' + str(y_usi - 3 * a / 4 + 3 * a / 8) + '\n')
    file.write('' + '\n')
    file.write('\n')
...
if wg_type == '1_3':
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_dsi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4- 4*a * math.sqrt(3) / 2) + ',' + str(y_dsi - a / 8 + a/4+4*a/2) + '\n')
    file.write(str(x_dsi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4- 3*a * math.sqrt(3) / 2) + ',' + str(y_dsi - a / 8 + a/4+3*a/2) + '\n')
    file.write(str(x_dsi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4- 2*a * math.sqrt(3) / 2) + ',' + str(y_dsi - a / 8 + a/4+2*a/2) + '\n')
    file.write(str(x_dsi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4- a * math.sqrt(3) / 2) + ',' + str(y_dsi - a / 8 + a/4+a/2) + '\n')
    file.write(str(x_dsi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4) + ',' + str(y_dsi - a / 8 + a/4) + '\n')
    ...
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4- 4*a * math.sqrt(3) / 2) + ',' + str(y_usi + a / 8 - a/4-4*a/2) + '\n')
    file.write(str(x_usi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4- 3*a * math.sqrt(3) / 2) + ',' + str(y_usi + a / 8 - a/4-3*a/2) + '\n')
    file.write(str(x_usi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4- 2*a * math.sqrt(3) / 2) + ',' + str(y_usi + a / 8 - a/4-2*a/2) + '\n')
    file.write(str(x_usi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4- a * math.sqrt(3) / 2) + ',' + str(y_usi + a / 8 - a/4-a/2) + '\n')
    file.write(str(x_usi - a * math.sqrt(3) / 24 - a * math.sqrt(3) / 4) + ',' + str(y_usi + a / 8 - a/4) + '\n')
    ...
    file.write(str(x_dsi-5*a * math.sqrt(3) / 2) + ',' + str(y_dsi+5*a/2) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi) + ',' + str(y_usi) + '\n')
    file.write(str(x_usi-5*a * math.sqrt(3) / 2) + ',' + str(y_usi-5*a/2) + '\n')
    file.write('' + '\n')
    file.write('\n')
if wg_type == '5_6':
    file.write('erase' + '\n')
    ...
    file.write('fence' + '\n')
    file.write(str(x_dsi) + ',' + str(y_dsi) + '\n')
    file.write(str(x_dsi-4*a * math.sqrt(3) / 2) + ',' + str(y_dsi+4*a/2) + '\n')
    file.write('' + '\n')
    file.write('\n')
    file.write('erase' + '\n')
    file.write('fence' + '\n')
    file.write(str(x_usi) + ',' + str(y_usi) + '\n')
    file.write(str(x_usi-4*a * math.sqrt(3) / 2) + ',' + str(y_usi-4*a/2) + '\n')
    file.write('' + '\n')
    file.write('\n')
